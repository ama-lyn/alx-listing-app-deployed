...
const PropertyList: React.FC<PropertyListProps> = ({ activeFilter }) => {
      ...
      <div className="w-full flex flex-col items-center justify-center py-16 px-4">
        <div className="text-center">
          ...
          <p className="text-gray-600">
            We couldn't find any properties matching "{activeFilter}".
            <br />
...
const PropertyListing: React.FC<PropertyListingProps> = ({ activeFilter = 'All' }) => {
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="mx-auto py-8">
        <PropertyList activeFilter={activeFilter} />
      </div>
    </div>
  );
};
